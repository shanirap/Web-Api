...
internal class Program
{
    ...
    {
        SqlManagement sqlManagement = new SqlManagement("Data Source=SRV2\\PUPILS;Initial Catalog=AdoNet;Integrated Security=True");
        bool flag = true;
        do
        { 
    ...
    {
        string connectionString = "Data Source=SRV2\\PUPILS;Initial Catalog=AdoNet;Integrated Security=True;Trust Server Certificate=True";
        //InsertProduct();
        Process();
    }      
    }
